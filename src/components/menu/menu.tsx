...
import type { MenuProps as ReactAriaMenuProps, MenuTriggerProps } from 'react-aria-components'

interface MenuProps<T> extends ReactAriaMenuProps<T>, Omit<MenuTriggerProps, 'children'> {
  label?: string
  icon?: string
